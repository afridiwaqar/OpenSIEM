...
\restrict DAm03eIf9sCmqE1PZWxvd6TrcyYFnkGtpESB4kWnfhc1aGkBIwzHroloJNNCaJg
...
SELECT pg_catalog.setval('public."Log_Source_source_id_seq"', 659552612, true);
...
SELECT pg_catalog.setval('public.alert_occurrences_id_seq', 60407, true);
...
SELECT pg_catalog.setval('public.alerts_id_seq', 55494, true);
...
SELECT pg_catalog.setval('public.calendar_data_id_seq', 659597331, true);
...
SELECT pg_catalog.setval('public.device_device_id_seq', 659551877, true);
...
SELECT pg_catalog.setval('public.message_message_id_seq', 717583187, true);
...
SELECT pg_catalog.setval('public.process_process_id_seq', 659551428, true);
...
SELECT pg_catalog.setval('public.watcher_health_id_seq', 333312058, true);
...
\unrestrict DAm03eIf9sCmqE1PZWxvd6TrcyYFnkGtpESB4kWnfhc1aGkBIwzHroloJNNCaJg
