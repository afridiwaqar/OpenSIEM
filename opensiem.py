...
TLS_ENABLED  = _conf.getboolean('tls', 'enabled',  fallback=True)
...
def start():
    ...
    if TLS_ENABLED:
        logging.info(f"[LISTENING] Server is listening on {SERVER}:{TCP_PORT} (TLS enabled)")
    else:
...
if __name__ == "__main__":
    ...
    correlation._start_admin_server()
